...
Sample Use:
https://myserver.com/transfer_demo.php?invoice=88322&from=sean.Skywallet.cc&amount=22&to=Billy.Skywallet.cc&
password=9812481556564824824856
...
if ($password == '9812481556564824824856'){
  ...
  */
  ...
  $command = "C:\\xampp\\htdocs\\exchange\\teller\\transferrer.exe -timeout=5 -transactionPath=TransactionLog\\ 
  -logpath=Logs\\transferrer -idpath=C:\\CloudCoin\\Accounts\\Change\\ID\\1.CloudCoin.1.11..stack -receiverID=$receiverID 
  -fromtag=$from -tag=$invoice -amount=$amount";
