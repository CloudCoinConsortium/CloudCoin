...
$apikey = 'ce5ec1e3bGet From Seanb3d46e9d107f6'; // Cloudflare Global API
$email = 'YourEmail@nmail.com'; // Cloudflare Email Adress
$domain = 'skywallet.cc';  // zone_name // Cloudflare Domain Name
$zoneid = '561ed8e8Get from sean16fd2cdc234'; // zone_id // Cloudflare Domain Zone ID
...
/*
 $get = curl_init("https://api.cloudflare.com/client/v4/zones/$zoneid/dns_records?type=A&content=$dnsipgeldi&match=all");
        ...
        if( strpos($return, 'count": 0') !== false )
		{
            //There is no record for that ip. 
           // echo "A record was found" .$return;
        }else{
          // echo "here" .$return;
