...
//die("https://api.cloudflare.com/client/v4/zones/".$zoneid."/dns_records?type=A&name=".$username."&content=".$dnsipgeldi);
    ...
    // A-record oluşturur DNS sistemi için.
		...
		//echo ("https://api.cloudflare.com/client/v4/zones/$zoneid/dns_records?type=A&name=$username&content=$dnsipgeldi&page=1&per_page=20&order=type&direction=desc&match=all");

		//curl_setopt($ch, CURLOPT_URL, "https://api.cloudflare.com/client/v4/zones/	$zoneid/dns_records?type=A&name=$username&content=$dnsipgeldi&page=1&per_page=20&order=type&direction=desc&match=all");
